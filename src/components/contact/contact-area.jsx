                ...
                <div className="row">
                    <div className="col-lg-6">
                        <div className="tp-contact-wrapper">
                            ...
                            <h3 className="tp-contact-title">ContactDBHdfsdSHDBJASDBHJ <span className="title-color">With us HA</span></h3> 
                            <p>Email, call, or complete thN  BM e form to learjcbnksjbcn how Kion can <br /> 
